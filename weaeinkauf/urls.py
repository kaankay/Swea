...
urlpatterns = [
    ...
    # ex: wind/servicepreisdetailsanzeigen/895/
    path("servicepreisdetailsanzeigen/<int:pk>/", views.servicepreisDetailsAnzeigen, name="servicepreisDetailsAnzeigen"),
    # ex: servicepreisdetailsanzeigen/<int:pk>/bearbeiten/
    path("servicepreisdetailsanzeigen/<int:pk>/bearbeiten/", views.servicepreisDetailsBearbeiten, name="servicepreisDetailsBearbeiten"),
