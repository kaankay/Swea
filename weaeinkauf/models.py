...
class Quelle(models.Model):
    ...
    quellenart = models.CharField(max_length=200, choices= quellenartOption, default= "")

    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

    def __str__(self):
        return f"ID: {self.id} / Alt ID: {self.alt_id} / Quellenart: {self.quellenart} Quellendatum: {self.quellendatum} / Bemerkung: {self.bemerkung} / Created_by: {self.created_by} / Created_at: {self.created_at}"
...
class Vertrag(models.Model):
    ...
    def __str__(self):
        return f"ID: {self.id} / Quelle Alt ID: {self.quellen_id} / Quellendatum: {self.quellendatum} / Bemerkung: {self.bemerkung} / Created_by: {self.created_by} / Created_at: {self.created_at} / Vertragskennung: {self.vertragskennung} / Vertragsart: {self.vertragsart}"
...
class Schaetzung(models.Model):
    ...
    def __str__(self):
        return f"ID: {self.id} / Quelle Alt ID: {self.quellen_id} / Quellendatum: {self.quellendatum} / Bemerkung: {self.bemerkung} / Created_by: {self.created_by} / Created_at: {self.created_at} / Schätzer: {self.schaetzer}"
...
class Angebot(models.Model):
    ...
    def __str__(self):
        return f"ID: {self.id} / Quelle Alt ID: {self.quellen_id} / Bemerkung: {self.bemerkung} / Created_by: {self.created_by} / Created_at: {self.created_at} / Wetterrisiko: {self.wetterrisiko} / Angebotskennung: {self.angebotskennung}"
...
class Indikation(models.Model):
    ...
    def __str__(self):
        return f"ID: {self.id} / Quelle Alt ID: {self.quellen_id} / Quellendatum: {self.quellendatum} / Bemerkung: {self.bemerkung} / Created_by: {self.created_by} / Created_at: {self.created_at}"
...
class ServicePreis(models.Model):
    ...
    def __str__(self):
        return f"ID: {self.id} / Alt ID: {self.alt_id} / Name: {self.name} / Laufzeit: {self.laufzeit} / Bemerkung: {self.bemerkung} / Created_by: {self.created_by} / Created_at: {self.created_at}"
...
class ServicePreisVerguetung(models.Model):
    ...
    def __str__(self):
        return f"ID: {self.id} / Alt Service-Preis ID: {self.servicePreisID} / Neu Service-Preis ID: {self.servicePreis.id} / Bemerkung: {self.bemerkung} / Var: {self.var} / Fix: {self.fix} / Created_by: {self.created_by} / Created_at: {self.created_at}"
...
class WeaPreis(models.Model):
    ...
    def __str__(self):
        return f"ID: {self.id} / Alt ID: {self.alt_id} / Weatyp ID: {self.weaTyp_id} / Preis: {self.preis} {self.waehrung} / Garantie: {self.garantie_verfuegbarkeit} / Preis(WEA Fundament): {self.preis_w_fundament} / Created_by: {self.created_by} / Created_at: {self.created_at}"
